            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <input v-model="edit_ma_giam_gia.ngay_het_han" type="date" class="form-control mt-2">
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input v-model="edit_ma_giam_gia.so_tien_toi_thieu" type="number" class="form-control mt-2">
                    </div>
                    <div class="mb-2">
        ...
        <div class="col-lg-3">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        <label>Thời Gian Kết Thúc</label>
                        <input v-model="create_ma_giam_gia.ngay_het_han" type="date" class="form-control mt-2">
                    </div>
                    <div class="mb-2">
                        <label>Loại Giảm</label>
                    ...
                    <div class="mb-2">
                        <label>Đơn Hàng Tối Thiểu</label>
                        <input v-model="create_ma_giam_gia.so_tien_toi_thieu" type="number" class="form-control mt-2">
                    </div>
                    <div class="mb-2">
                        <label>Tình trạng</label>
