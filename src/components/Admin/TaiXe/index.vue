        ...
        <div class="row">
            <div class="card rounded-4">
                ...
                <div
                    ...
                    <h1 class="text-white">QUẢN LÝ THÔNG TIN TÀI XẾ</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center"><b>Danh sách tài xế</b></h3>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <button v-if="value.trang_thai"
                                                    ...
                                                    class="btn btn-success me-2">Đang hoạt
                                                    động</button>
                                                <button v-else v-on:click="actionDoiTrangThaiTaiKhoan(value)"
                                                    class="btn btn-danger">Tạm Ngừng </button>
                                            </td>
                                            <td class="align-middle text-center">
                                                <button v-on:click="Object.assign(edit_tai_xe, value)"
                                                    class="btn btn-primary me-2" data-bs-toggle="modal"
                                                    data-bs-target="#CapNhatTaiXe">Cập nhật</button>
