        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-lg border-0 rounded-4 p-4">
                    <h2 class="mb-4 text-center">Liên Hệ Hỗ trợ</h2>
                    ...
                    <div class="mb-3">
                        ...
                        <input v-model="form.ho_ten" type="text" class="form-control" placeholder="Nhập họ và tên" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea v-model="form.noi_dung" class="form-control" rows="4"
